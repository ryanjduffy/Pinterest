...
a = window.webkitCancelRequestAnimationFrame || window.clearTimeout, enyo.cancelRequestAnimationFrame = function(b) {
return a(b);
};
})(), enyo.easing = {
cubicIn: function(a) {
...
if (d) {
var e = a.captureTarget = this.captureTarget;
this.dispatchBubble(a, e), this.captureTarget && !this.autoForwardEvents[a.type] && !this.forwardEvents && (a.preventDispatch = !0);
}
...
enyo.dispatch(b), a.requireTouchmove = b.requireTouchmove, this.trackInfo && this.track(b);
},
up: function(a) {
this.cancelHold();
...
this.trackInfo = {}, this.track(a);
},
track: function(a) {
var b = this.trackInfo;
b.d1 && (b.d0 = b.d1), b.d1 = {
x: a.pageX,
y: a.pageY,
t: (new Date).getTime()
...
var b = this.trackInfo;
if (b && b.d1 && b.d0) {
var c = b.d1, d = b.d0, e = (new Date).getTime() - d.t, f = (c.x - d.x) / e, g = (c.y - d.y) / e, h = Math.sqrt(f * f + g * g);
h > this.minFlick && this.sendFlick(a, f, g, h);
}
this.trackInfo = null;
},
over: function(a) {
...
var e = this.makeEvent("flick", a);
e.xVelocity = b, e.yVelocity = c, e.velocity = d, e.target = this.target, enyo.dispatch(e);
}
...
move: function(a) {
if (this.tracking) {
this.dx = a.pageX - this.px0, this.dy = a.pageY - this.py0;
if (!a.which) {
this.stopDragging(a), this.tracking = !1, console.log("enyo.gesture.drag: mouse must be down to drag.");
return;
}
this.dragEvent ? this.sendDrag(a) : Math.sqrt(this.dy * this.dy + this.dx * this.dx) >= this.hysteresis && this.sendDragStart(a);
}
},
up: function(a) {
...
a.drag.hysteresis = 0, a.events = b, a.events.touchstart(c);
};
var b = {
...
a.move(d), enyo.preventDocumentScrolling && !d.requireTouchmove && b.preventDefault(), this.overEvent && this.overEvent.target != d.target && (this.overEvent.relatedTarget = d.target, d.relatedTarget = this.overEvent.target, a.out(this.overEvent), a.over(d)), this.overEvent = d;
},
touchend: function(b) {
...
create: function() {
this.inherited(arguments), this.horizontalChanged(), this.verticalChanged(), this.nofitChanged(), this.setAttribute("onscroll", enyo.bubbler);
},
...
nofitChanged: function() {
this.inherited(arguments), this.$.client.addRemoveClass("enyo-fit", !this.nofit);
},
...
a && (this.$.scroll.vertical = this.scrollNode.scrollHeight > c.height), b && (this.$.scroll.horizontal = this.scrollNode.scrollWidth > c.width);
}
},
...
if (this.dragging) {
b.preventNativeDefault(), this.syncScrollMath(), this.$.scroll.startDrag(b);
if (this.preventDragPropagation) return !0;
}
},
dragHandler: function(a, b) {
this.dragging && (b.preventNativeDefault(), this.$.scroll.drag(b));
},
...
var a = this.$.scroll, b = this.$.client.getBounds();
...
getScrollBounds: function() {
var a = this.inherited(arguments), b = this.$.scroll;
...
importProps: function(a) {
this.inherited(arguments), a && a.strategyKind === undefined && enyo.Scroller.forceTouchScrolling && (this.strategyKind = "TouchScrollStrategy");
},
initComponents: function() {
...
kind: enyo.Layout,
constructor: function(a) {
this.inherited(arguments), a.applyStyle("position", "relative");
},
reflow: function() {
...
create: function() {
navigator.userAgent.match("MSIE") && (this.handlers.onkeyup = "keyup"), this.inherited(arguments), this.disabledChanged(), this.placeholderChanged(), this.valueChanged();
},
...
setValue: function(a) {
this.setPropertyValue("value", a, "valueChanged");
},
...
initComponents: function() {
this.rowComponents = this.components, this.components = null, this.inherited(arguments);
},
build: function() {
